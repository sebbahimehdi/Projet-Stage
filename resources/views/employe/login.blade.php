           ...
           <div class="container">
               <div class="row">
                   <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                       <form class="card login-form" action="{{route('employe.dashbord.check')}}"  method="post">
                           @csrf
                           <div class="card-body">
                               <div class="title">
                                   <h3>Login employe</h3>
                               ...
                               {{-- @guest
                               <p class="outer-link">Don't have an account? <a href="{{route('employe.dashbord.registar')}}">Inscription </a>
                               @endguest --}}
